...
void testShowProf_rawevent_v5(char* rootfile, int nevn)
{
  ...
  hnpeak_coin = new TH1F("hnpeak_coin","hnpeak_coin",2500,0,2500);
  hnpeak = new TH1F("hnpeak","hnpeak",2500,0,2500);
   ...
   { 
	   ...
	   //	  printf("delta0 \n");
           for(int k = 0; k<npeak_ch0[i] ; k++) 
	     {
		  ...
		  if( delta_time0 <100 && delta_time0 >=0) 
		   {
		    coin0 = 1;
		    break;
		   }else 
	    ...
	    //	  printf("delta1 \n");
           for(int l = 0; l<npeak_ch1[i] ; l++) 
	     {
		  ...
		  if( delta_time1 <100 && delta_time1 >=0)
		   {
		    coin1 = 1;
		    break;
		   }else 
	    ...
	    //	  printf("delta2 \n");
           for(int m = 0; m<npeak_ch2[i] ; m++) 
	     {
		  ...
		  if( delta_time2 <100 && delta_time2 >=0)
		   {
		    coin2 = 1;
		    break;
		   }else 
...
//
   ...
   TCanvas *c11 = new TCanvas("c11","hnpeak",200,10,700,500);
   TCanvas *c12 = new TCanvas("c12","hnpeak_coin",200,10,700,500);
  ...
  c11->SetGridx();
  c11->SetGridy();
  hnpeak_coin->SetXTitle("npeak_coin");
  hnpeak_coin->Draw();
  c12->cd();
  c12->SetGridx();
  c12->SetGridy();
  hnpeak->SetXTitle("npeak");
  hnpeak->Draw();
