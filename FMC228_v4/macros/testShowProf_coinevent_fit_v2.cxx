...
void testShowProf_coinevent_fit_v2(char* rootfile, int nevn)
{
  ...
  hprof2d_vpeakhigh_coin_505000_509000_ns = new TProfile2D("hprof2d_vpeakhigh_coin_505000_509000_ns","vprofile 2D peakhigh coin_ns  ",4000,505000,509000,5000,0,5000,-2500,0);
  ...
  hprof2d_vpeaksum_coin_us_batch3_time2 = new TProfile2D("hprof2d_vpeaksum_coin_us_batch3_time2","vprofile 2D peaksum coin_us_time2  ",3000,466000,469000,5000,0,5000,-30000,0);
  ...
  htime = new TH1F("htime","time2 - time1",10000,-100000,100000);
  ...
  //for(int i= 0; i< 10 ;i++)
   { 
	printf("event %d \n",i);
        ...
        {	   
           ...
           hprof2d_vpeakhigh_coin_us_batch3 -> Fill(ch_vpeakhigh_time_us[i][3][j],i,ch_vpeakhigh[i][3][j],1);
           hprof2d_vpeakhigh_coin_505000_509000_ns -> Fill(ch_vpeakhigh_time_ns[i][3][j],i,ch_vpeakhigh[i][3][j],1);
       ...
       for(int k=0; k<nsum_ch3[i] ; k++)
	{
           ...
           ch_vpeaksum_time2_ms[i][3][k]=coineventfitfunction->GetVPeakSumTime2()[k]*0.000001; //convert to ms
           ch_vpeaksum_time2_us[i][3][k]=coineventfitfunction->GetVPeakSumTime2()[k]*0.001; //convert to us
           ch_vpeaksum_time2_ns[i][3][k]=coineventfitfunction->GetVPeakSumTime2()[k]; //ns
	   htime -> Fill(ch_vpeaksum_time2_ns[i][3][k] - ch_vpeaksum_time_ns[i][3][k]);
           ...
           hprof2d_vpeaksum_coin_us_batch3_time2 -> Fill(ch_vpeaksum_time2_us[i][3][k],i,ch_vpeaksum[i][3][k],1);
   ...
   TCanvas *c4_0 = new TCanvas("c4_0","profile",200,10,700,500);
   ...
   TCanvas *c3_3t2_sum = new TCanvas("c3_3t2_sum","profile",200,10,700,500);
   ...
   TCanvas *c_time = new TCanvas("c_time","time2 - time 1",200,10,700,500);
  ...
  c4_0->SetGridx();
  c4_0->SetGridy();
  hprof2d_vpeakhigh_coin_505000_509000_ns->SetStats(kFALSE);
  hprof2d_vpeakhigh_coin_505000_509000_ns->GetXaxis()->SetTitle("Time(ns)");
  hprof2d_vpeakhigh_coin_505000_509000_ns->GetYaxis()->SetTitle("Events");
  hprof2d_vpeakhigh_coin_505000_509000_ns->Draw("colz");
  c4_1->cd();
  c4_1->SetGridx();
  c4_1->SetGridy();
  ...
  c3_3t2_sum->SetGridx();
  c3_3t2_sum->SetGridy();
  hprof2d_vpeaksum_coin_us_batch3_time2->SetStats(kFALSE);
  hprof2d_vpeaksum_coin_us_batch3_time2->GetXaxis()->SetTitle("Time(us)");
  hprof2d_vpeaksum_coin_us_batch3_time2->GetYaxis()->SetTitle("Events");
  hprof2d_vpeaksum_coin_us_batch3_time2->Draw("colz");
  c4_1_sum->cd();
  c4_1_sum->SetGridx();
  c4_1_sum->SetGridy();
  ...
  c_time->SetGridx();
  c_time->SetGridy();
  htime->GetXaxis()->SetTitle("time2 - time1");
  htime->Draw();
