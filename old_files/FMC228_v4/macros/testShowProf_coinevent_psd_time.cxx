...
void testShowProf_coinevent_psd_time(char* rootfile, int nevn)
{
  ...
  tr->SetBranchAddress("coinevn.",&coinevent);
  ...
  //for(int i= 0; i< 10 ;i++)
   { 
       ...
       for(int k=0; k<nsum_ch3[i] ; k++)
	{
           ...
           ch_vpeaksum0[i][3][k]=coinevent->GetVPeakSum0()[k];
           //ch_vpeaksum_tail[i][3][k]=coinevent->GetVPeakSum_tail()[k];
           ch_vpeaksum_peak[i][3][k]=coinevent->GetVPeakSum0_peak()[k];
