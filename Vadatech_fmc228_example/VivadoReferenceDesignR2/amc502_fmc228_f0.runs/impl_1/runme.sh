...
HD_PWD='/disk2/data/tmnguyen/mu2e_monitor_firmware_original/Vadatech_fmc228_example/VivadoReferenceDesignR2/amc502_fmc228_f0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log amc502_fmc228_fpga_f0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source amc502_fmc228_fpga_f0.tcl -notrace
