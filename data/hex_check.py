...
event_to_hex = {
    ...
    # ↓　(sub event)
    "begin_sub_event": {"re": r"00ffffff", "next": ["byte_order"], "show": False, "data_chars": [0, 0]},
    "byte_order": {"re": r"f4f3f2f1", "next": ["fmc228_number"], "show": False, "data_chars": [0, 0]},
    ...
    "bco_low": {"re": r"........", "next": ["bco_high"], "show": False, "data_chars": [0, 8]},
    "bco_high": {"re": r"........", "next": ["end_of_channel", "raw_data"], "show": False, "data_chars": [0, 8]},
    "raw_data": {"re": r"........", "next": ["end_of_channel", "raw_data"], "show": False, "data_chars": [0, 8]},
    "end_of_channel": {"re": r"fbfbfbfb", "next": ["end_raw_data", "channel_header"], "show": False,
                       "data_chars": [0, 0]},
    ...
    # ↓ ↓ ↓　(data of one channel)
    "channel_number": {"re": r"eeee....", "next": ["peak_finding_header"], "show": False, "data_chars": [4, 8]},
    "peak_finding_header": {"re": r"aaaaaaaa", "next": ["peak_height_header"], "show": False, "data_chars": [0, 0]},
    "peak_height_header": {"re": r"cccccccc", "next": ["peak_height_data"], "show": False, "data_chars": [0, 0]},
    ...
    "peak_area_header": {"re": r"dddddddd", "next": ["peak_area_data"], "show": False, "data_chars": [0, 0]},
    ...
    "end_peak_channel": {"re": r"ecececec", "next": ["end_peak_stream_data", "channel_number"], "show": False,
                         "data_chars": [0, 0]},
    # ↑ ↑ ↑ end of (data of one channel)
    "end_peak_stream_data": {"re": r"edededed", "next": ["end_of_sub_event"], "show": False, "data_chars": [0, 0]},
    # ↑ ↑ end of (peak stream data)
    "end_of_sub_event": {"re": r"00fcfcfc", "next": ["end_of_event", "begin_sub_event"], "show": False, "data_chars": [0, 0]},
    # ↑ end of (sub event)
    "end_of_event": {"re": r"fcfcfcfc", "next": ["begin_event"], "show": False, "data_chars": [0, 0]}
}
...
def main():
    ...
    # open binary file
    with open(dir + input_file, "rb") as file:
