...
HD_PWD='/disk2/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/gtwizard_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source gtwizard_0.tcl
