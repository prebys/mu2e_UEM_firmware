...
HD_PWD='/disk2/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/peakhigh_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log peakhigh_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source peakhigh_fifo.tcl
