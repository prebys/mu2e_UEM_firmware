...
HD_PWD='/disk2/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/gig_ethernet_pcs_pma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gig_ethernet_pcs_pma_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source gig_ethernet_pcs_pma_0.tcl
