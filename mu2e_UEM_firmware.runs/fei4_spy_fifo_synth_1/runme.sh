...
HD_PWD='/disk2/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/fei4_spy_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fei4_spy_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fei4_spy_fifo.tcl
