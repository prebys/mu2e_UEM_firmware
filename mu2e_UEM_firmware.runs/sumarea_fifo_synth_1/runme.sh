...
HD_PWD='/root/Documents/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/sumarea_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumarea_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sumarea_fifo.tcl
