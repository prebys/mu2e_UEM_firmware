...
HD_PWD='/disk2/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/jesd204_phy_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jesd204_phy_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source jesd204_phy_1.tcl
