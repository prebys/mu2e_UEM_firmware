...
HD_PWD='/root/Documents/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fmc228_pcie.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_fmc228_pcie.tcl
