...
HD_PWD='/root/Documents/mu2e/mu2e_UEM_firmware/mu2e_UEM_firmware.runs/bd_fc5c_dlmb_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_fc5c_dlmb_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bd_fc5c_dlmb_0.tcl
